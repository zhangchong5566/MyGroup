...
<body style="padding:20px;">
	<form id="form1" action="saveRole.do" method="post">
	<input type="hidden" name="role.id" value="${role.id}">
	<div id="cont" class="portlet-body form-horizontal form-bordered form-row-stripped" style="padding:10px;">
			<div id="add" class="ss">
				<div style="margin-left:2px;">
					<div>
						<input type="text" name="role.name" id="code" class="m-wrap small {required:true,url:false,messages:{required:'Role name is required'}}" value="${role.name}" placeholder="Role name" style="width:90% !important;"/>
						<span style='color:red' class='msg'></span>
					</div>
					<div>
						<input type="text" name="role.description" id="description" class="m-wrap small" value="${role.description}" placeholder="Role describe" style="width:90% !important;"/>
						<span style='color:red' class='msg'></span>
					</div>
				</div>
			</div>
