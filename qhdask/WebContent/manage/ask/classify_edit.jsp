...
<body style="padding:20px;">
	<form id="form1" action="saveClassify.do" method="post">
	...
	<div id="cont" class="portlet-body form-horizontal form-bordered form-row-stripped" style="padding:10px;">
			<div id="add" class="ss">
				<div style="margin-left:2px;">
					<div>
						<input type="text" name="name" id="name" class="m-wrap small {required:true,url:false,messages:{required:'分类名称不能为空'}}" value="${classify.name}" placeholder="分类名称" style="width:90% !important;"/>
						<span style='color:red' class='msg'></span>
					</div>
					<div>
						<input type="text" name="orderBy" id="orderBy" class="m-wrap small {required:true,number:true,messages:{required:'顺序号不能为空',number:'顺序号只能是数字'}}" value="${classify.orderBy}" placeholder="顺序号" style="width:50% !important;"/>
						<span style='color:red' class='msg'></span>
					</div>
				</div>
			</div>
